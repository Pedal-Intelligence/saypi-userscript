...
The final candidate combines the preference fix (PR #608), Pi return fix (PR #607), this studio pass, and the offscreen readiness race found during verification (PR #611). The [candidate evidence record](../release/evidence/2026-09-05-voice-choice/README.md) identifies exact commits and full-suite/browser outcomes, including the additional font-width regression found by Linux CI. The founder removed attended audio and screen-reader checks as release prerequisites on 2026-09-05; the evidence record distinguishes automated results from historical live observations. Production packaging, release-risk acceptance (#544), version bump and store submission remain outside these review PRs.
